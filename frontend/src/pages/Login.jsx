...
const Login = () => {
  ...
  return (
    <>
      <SEO noindex title={t("loginPage.seoTitle")} />
      <AuthShell
        badge={t("auth.tags.welcomeBack")}
        title={t("loginPage.heroTitle")}
        description={t("user.welcome")}
      >
        <CardHeader className="px-0 pt-0">
          <CardTitle className="text-center text-primary-900">{t("auth.loginTitle")}</CardTitle>
